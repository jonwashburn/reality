...
/-- Uniqueness up to units quotient (scaffold): any two such morphisms are equal. -/
axiom initial_morphism_unique (G : Framework) : ∀ f : ZeroParam.Morphism RS G, f = initial_morphism G

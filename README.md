...
- **Assumptions index:** surfaced prerequisites and demo inputs are tracked in `docs/Assumptions.md`, including the exclusivity/recognition assumption bundles (`NoAlternativesAssumptions`, `BoundedCapacity`, `RecognitionEventsCountable`, `ComparisonAssumptions`).
